...
import { MOCK_PULSE_REPORTS, addPulseReport, PulseReport } from '@/lib/pulse-data'
...
export default function PulsePage() {
  ...
  const handleReportSubmit = (data: Omit<PulseReport, 'id' | 'status' | 'dateSubmitted' | 'confirmations' | 'adminUpdates'>) => {
    const newReport = addPulseReport(data)
    setReports(MOCK_PULSE_REPORTS) // update local state to reflect the global state change
  }
